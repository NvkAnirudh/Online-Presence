...
(function() {
  ...
  // portfolio code
  // Get the filter list and card container
  const filterList = document.querySelector('.portfolio-filters');
  const cardContainer = document.querySelector('.portfolio-cards');
  // console.log(filterList)
  // console.log(cardContainer)

  // Add event listener to filter list
  filterList.addEventListener('click', (e) => {
    // Check if the clicked element is a filter item
    if (e.target.classList.contains('filter-item')) {
      // Remove active class from all filter items
      const filterItems = filterList.children;
      Array.from(filterItems).forEach((item) => item.classList.remove('active'));
